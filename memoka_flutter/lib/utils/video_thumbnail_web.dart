...
///
/// Creates a temporary video element, seeks to 1s, draws the frame onto a
/// canvas, and returns the image as JPEG bytes.
Future<Uint8List?> extractVideoThumbnail(Uint8List videoBytes) async {
  try {
    final blob = web.Blob(
    ...
    video.load();
    await metaCompleter.future.timeout(const Duration(seconds: 5));
